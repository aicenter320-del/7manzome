...
- هیرو خانه در دسکتاپ عکس راست‌وزن با ماسک `.hero-photo-mask` است و کارت شیشه روی چپ شناور می‌ماند.
- کلاس `.home-hero` عکس را تا بالای ویوپورت می‌کشد تا از زیر نوار چسبان شروع شود.
