...
خالی است داده نمونه می‌ریزد؛ استقرار بعدی روی volume پر، کاتالوگ واقعی را بازنویسی نمی‌کند.
روی سروری که الان دیتابیس خالی دارد، یک‌بار `npm run db:seed` داخل کانتینر یا بازسازی
ایمیج کافی است.
