...
- اسلایدر مناسبت خانه (`OccasionSlider`) کارت فعال را وسط می‌گذارد و کارت‌های کناری از دو طرف با سایه دیده می‌شوند. اسلایدر محصول peek از لبه است. زیر کارت‌ها نقطه‌های کوچک است و اسلاید فعال کپسول طلایی کوتاه است. موتور مشترک: `SnapSlideTrack`. سربرگ با `SectionHead` بیرون از اسلایدر است.
