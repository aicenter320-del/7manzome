...
- پنل کارت هدیه انتساب به گنجینه، علامت چاپ و QR لینک فعال را روی همین سرویس نشان می‌دهد.
...
- `app/admin/gift-cards` — ساخت دسته، انتساب، چاپ، QR و ابطال

## نقاط باز

- پیام ویدیویی برای کودک: فاز دوم.
- چاپ دسته‌ای PDF کارت هدیه فیزیکی: فاز بعد؛ در پنل انتساب، چاپ، QR و ابطال هست.
